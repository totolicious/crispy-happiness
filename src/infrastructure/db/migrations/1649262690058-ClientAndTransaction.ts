...
export class ClientAndTransaction1649262690058 implements MigrationInterface {
    name = 'ClientAndTransaction1649262690058'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "client" ("id" SERIAL NOT NULL, "commissionPercent" double precision, CONSTRAINT "PK_96da49381769303a6515a8785c7" PRIMARY KEY ("id"))`);
